...
export async function run(ctx: TestCtx): Promise<void> {
  ...
  assert(detectGarbledToolCall('<invoke name="set_window_prop">') === true, 'invoke name tag detected')
  ...
  assert(detectGarbledToolCall('please use set_window_prop to update') === false, 'normal mention of tool name not garbled')
}

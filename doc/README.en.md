...
- **Self-tests**: `npm test` (`../src/core/__tests__/selftest.ts`, 1092 assertions) + `npm run test:e2e` (integration e2e, 283 assertions) + `npm run test:browser` (browser E2E, 25 assertions)

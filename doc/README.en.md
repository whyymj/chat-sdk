...
- **Self-tests**: `npm test` (`../src/core/__tests__/selftest.ts`, 1130 assertions) + `npm run test:e2e` (integration e2e, 286 assertions) + `npm run test:browser` (browser E2E, 25 assertions)

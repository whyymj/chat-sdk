# page-agent-sdk 进化设计规划书(Roadmap)

> 目标:在保留「网页内嵌 + window 安全操作」差异化优势的前提下,把 page-agent-sdk 从「页面操作助手」升级为「可对标成熟 agent(Claude Code 等)的通用 harness」。
>

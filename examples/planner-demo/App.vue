...
if (!w.appConfig) w.appConfig = reactive<AppConfig>({ theme: 'fresh-blue', density: 'cozy', radius: 12, accent: '#3b82f6' })
    ...
    dataSlots: [
      {
        ...
        schema: z.object({
          theme: z.enum(['fresh-blue', 'night-purple', 'warm-orange', 'forest-green']),
